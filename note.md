...
- 组合 B：`ret` 指令紧接着 `mrmovq D(rB), %rsp` 或 `popq %rsp` 指令
...
|        处理 `ret`        | 暂停  | 气泡  | 正常  | 正常  | 正常  |
|      预测错误的分支      | 正常  | 气泡  | 气泡  | 正常  | 正常  |
| `jXX Dest; ret` 简单合并 | 暂停  | 气泡  | 气泡  | 正常  | 正常  |
...
|  预测错误的分支   | 正常  |    气泡     | 气泡  | 正常  | 正常  |
|  加载 / 使用冒险  | 暂停  |    暂停     | 气泡  | 正常  | 正常  |
|  `jXX Dest; ret`  | 暂停  |    气泡     | 气泡  | 正常  | 正常  |
|  组合 B 简单合并  | 暂停  | 气泡 + 暂停 | 气泡  | 正常  | 正常  |
| 组合 B 期望的情况 | 暂停  |    暂停     | 气泡  | 正常  | 正常  |
